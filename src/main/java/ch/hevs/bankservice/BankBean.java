...
//Changements pour assurer la persistance du entityManager méthode 1
//@Stateful
@Stateless
public class BankBean implements Bank {
	...
	public void transfer(Account srcAccount, Account destAccount, int amount) {
		...
		//Changements pour assurer la persistance du entityManager méthode 2	
		srcAccount= em.merge(srcAccount);
		destAccount= em.merge(destAccount);
